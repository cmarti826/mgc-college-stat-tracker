        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 space-y-6">
          ...
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24">
              ...
              <path fill="#EA4335" d="M12 6.5c1.61 0 3.05.55 4.18 1.64l3.12-3.12C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.41 6.16-4.41z" />
            </svg>
            Continue with Google
          </button>

          <div className="text-center text-sm text-gray-500">
            <p>By continuing, you agree to our <a href="/terms" className="underline">Terms</a> and <a href="/privacy" className="underline">Privacy Policy</a></p>
          </div>
        </div>
      </div>
    </div>
